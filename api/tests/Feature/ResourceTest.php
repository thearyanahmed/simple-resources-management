...
class ResourceTest extends TestCase
{
    ...
    public function test_html_snippet_can_not_be_created_with_invalid_data()
    {
        ...
        $testCases = [
            ...
            ['data' => [ 'description' => $this->faker->realText(mt_rand(300,400)) , 'markup' => $this->faker->randomHtml(1,1) , 'title' => $this->faker->realText(mt_rand(260,400)) , 'resource_type' => 'html_snippet'], 'errors' => [ 'title' => ['The title must not be greater than 255 characters.'] , 'description' => ['The description must not be greater than 255 characters.'] ]],
